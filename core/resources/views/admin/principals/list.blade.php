                ...
                <div class="card-body p-0">
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            <thead>
                            <tr>
                                <th scope="col">@lang('Principal Profile Image')</th>
                                ...
                                @forelse($doctors as $doctor)
                                    <tr>
                                        <td data-label="@lang('Coach')">
                                            <div class="user">
                                                <div class="thumb"><img src="{{ asset(imagePath()['principal']['path'].'/'. $doctor->profile_image,imagePath()['principal']['size'])}}" alt="@lang('image')"></div>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <a href="{{ route('admin.principals.detail', $doctor->id) }}" class="icon-btn" data-toggle="tooltip" title="" data-original-title="@lang('Details')">
                                                <i class="las la-pencil-alt text--shadow"></i>
                                            </a>
                                            &nbsp;
                                            <a href="{{ route('admin.principals.addAvailable', $doctor->id) }}" class="icon-btn" data-toggle="tooltip" title="" data-original-title="@lang('Details')">
                                               Manage Times
                                            </a>
                                        </td>
