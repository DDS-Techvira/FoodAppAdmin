...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-xl-3 col-lg-5 col-md-5 mb-30">
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted">@lang('Principal action')</h5>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{route('admin.principals.password.reset', $doctor->id)}}" method="POST" id="password-reset-form">
                                        @csrf
        ...
        <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
            <div class="card ">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.principals.update',$doctor->id) }}" method="POST"
