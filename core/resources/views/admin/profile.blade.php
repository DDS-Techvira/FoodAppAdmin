                ...
                <div class="card-body p-0">
                    <div class="d-flex p-3 bg--primary align-items-center">
                        <div class="avatar avatar--lg">
                            <img src="{{ asset('assets/admin/images/profile/'.auth()->guard('admin')->user()->image) }}" alt="@lang('profile-image')">
                        </div>
                        <div class="pl-3">
                                        ...
                                        <div class="thumb">
                                            <div class="avatar-preview">
                                                <div class="profilePicPreview" id="profilePicPreview">
                                                    ...
                                                    <img id="img-preview" width="100%" src="{{ asset('assets/admin/images/profile/'.auth()->guard('admin')->user()->image) }}" />
                                                </div>
                                            </div>
