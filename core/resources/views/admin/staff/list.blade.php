                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($staff as $item)
                                <tr>
                                    ...
                                    <td data-label="@lang('Username')"><a href="{{ route('admin.staff.detail', $item->id) }}">{{ $item->username }}</a></td>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="{{ route('admin.staff.detail', $item->id) }}" class="icon-btn" data-toggle="tooltip" title="" data-original-title="Details">
