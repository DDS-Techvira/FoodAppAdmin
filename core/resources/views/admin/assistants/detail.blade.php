    ...
    <div class="row mb-none-30">
        <div class="col-xl-3 col-lg-5 col-md-5 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body p-0">
                    <div class="p-3 bg--white">
                        <div class="">
                            <img src="{{ getImage(imagePath()['assistant']['path'].'/'. $assistant->image,imagePath()['assistant']['size'])}}" alt="@lang('image')" class="b-radius--10 w-100">
                        </div>
                        <div class="mt-15">
                            <h4 class="">{{__($assistant->name)}}</h4>
                            <span class="text--small">@lang('Joined On') <strong>{{date('d M, Y h:i A',strtotime($assistant->created_at))}}</strong></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted">@lang('Assistant information')</h5>
                    <ul class="list-group">

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Username')
                            <span class="font-weight-bold">{{$assistant->username}}</span>
                        </li>
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted">@lang('Assigned Doctors')</h5>
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.doctors.detail',$item->id) }}"><span class="font-weight-bold">{{$item->name}}</span></a>
                        </li>
                        @endforeach
                    </ul>
                </div>
        ...
        <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
            ...
            <div class="row mb-none-30">
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--gradi-1 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="currency-sign"> {{$total_doctor}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Assigned Doctors')</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--gradi-15 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="currency-sign">{{$done_appointment}}</span>
                            </div>
                            <div class="desciption">
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--gradi-21 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            ...
                            <div class="desciption">
                                <span>@lang('New Appointments')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
            ...
            <div class="card mt-50">
                <div class="card-body">
                    <h5 class="card-title mb-50 border-bottom pb-2">{{$assistant->name}} @lang('Information')</h5>
                    ...
                    <form action="{{ route('admin.assistants.update',$assistant->id) }}" method="POST"
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Email') <span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" type="email" name="email" value="{{$assistant->email}}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label  font-weight-bold">@lang('Mobile Number') <span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="mobile" value="{{$assistant->mobile}}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="address"
                                           value="{{$assistant->address}}" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Doctors')</label>
                                    <select class="select2-multi-select" name="doctor_id[]" multiple="multiple">
                                        @foreach ($doctors as $item)
                                            <option
                                                @foreach ($assistant->doctors as $data)
                        ...
                        <div class="row">
                            <div class="form-group col-xl-4 col-md-6  col-sm-3 col-12">
                                ...
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                       ...
                                       name="status"
                                       @if($assistant->status) checked @endif>
                            </div>
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted">@lang('Assistant action')</h5>
                    <a href="{{ route('admin.assistants.login.history.single', $assistant->id) }}"
                       class="btn btn--primary btn--shadow btn-block btn-lg">
                       @lang('Login Logs')
                    </a>
                    <a href="{{route('admin.assistants.email.single',$assistant->id)}}"
