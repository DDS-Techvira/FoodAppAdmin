...
<div class="row mb-none-30">
    ...
    <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
        <form action="{{ route('assistant.appointments.store',$doctor->id) }}" method="post">
            @csrf
                ...
                <div class="card-body p-0">
                    <div class="p-3 bg--white">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control" value="{{old('email')}}" placeholder="@lang('Example : demo@gmail.com')" required>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    (function ($) {
        ...
        $(document).on('change','select[name=booking_date]',function(){
            ...
            var url = "{{route('assistant.appointments.booked.date')}}";
            var date = $(this).val();
